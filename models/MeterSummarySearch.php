...
{
    public $min_start_timestamp;
    public $max_start_timestamp;
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['meter_id', 'start_timestamp', 'end_timestamp', 'min_start_timestamp', 'max_start_timestamp'], 'integer'],
    ...
    public function search($params)
    {
        ...
        if (null !== $this->min_start_timestamp) {
            $query->andFilterWhere(['>=', 'start_timestamp', $this->min_start_timestamp]);
        }

        if (null !== $this->max_start_timestamp) {
            $query->andFilterWhere(['<=', 'start_timestamp', $this->max_start_timestamp]);
        }
